...
The following SQL statement selects all records from the teable named "Customers":
...
The table above contains five records (one for each customer) and seven columns (CustomerID, CustomerName, Address, City, PostalCode, and Country).
